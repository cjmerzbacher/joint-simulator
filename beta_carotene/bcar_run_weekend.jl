    ...
    for i in 1:num_iters
        ...
        if i%5 == 0 
            if save_data
                ...
                CSV.write(home_path * "beta_carotene/exp_data/bo_data_1v.csv", bo_data)
                CSV.write(home_path * "beta_carotene/exp_data/sim_fba_data_1v.csv", sim_fba_data)
                CSV.write(home_path * "beta_carotene/exp_data/sim_ode_data_1v.csv", sim_ode_data)
                CSV.write(home_path * "beta_carotene/exp_data/sum_data_1v.csv", sum_data)
            end
        end
    end
    #Save out BO data and simulation data
...
scaled_plan = scaled_plan[101:600, :]
